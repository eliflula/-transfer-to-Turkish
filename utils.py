...
def translate_dataframe(df, source_language, target_language):
    ...
    column_args = [(df[column], target_language, source_language) for column in df.columns]
    processed_columns=translate_text(df,target_language=target_language,source_language=source_language)
    print(translate_text("hello my name is elif",target_language=target_language,source_language=source_language))
